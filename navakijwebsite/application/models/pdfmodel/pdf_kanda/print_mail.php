...
class Print_mail extends CI_Model
{
    ...
    public function make($tax_id)
    {
        ...
        $this->fpdf->Cell(60, 6, '', 0, 0, 'L');
        $this->fpdf->Cell(215, 6, setUTF8('บริษัท กานดา ดิจิทัล จำกัด'), 0, 1, 'L');
        $this->fpdf->SetFont('brow', '', 14);
        $this->fpdf->Cell(60, 6, '', 0, 0, 'L');
        $this->fpdf->Cell(230, 6, setUTF8('เลขที่ 99 ชั้นที่ 3 ห้องเลขที่ L3-A03 ถนนรามคำแหง'), 0, 1, 'L');
        $this->fpdf->Cell(60, 6, '', 0, 0, 'L');
        $this->fpdf->Cell(230, 6, setUTF8('แขวงสวนหลวง เขตสวนหลวง'), 0, 1, 'L');
        $this->fpdf->Cell(60, 6, '', 0, 0, 'L');
        $this->fpdf->Cell(230, 6, setUTF8('กรุงเทพมหานคร'), 0, 1, 'L');
        $this->fpdf->SetFont('brow', 'B', 18);
        $this->fpdf->Cell(60, 6, '', 0, 0, 'L');
        $this->fpdf->Cell(230, 8, setUTF8('10250'), 0, 1, 'L');
