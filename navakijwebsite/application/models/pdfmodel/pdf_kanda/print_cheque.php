  ...
  function cheque($cheque_id)
	{
	    ...
	    $this->fpdf->AddPage('L','kbank_cheque');
...
//    	$this->fpdf->Text( $left_margin+7  , $top_margin+82 , setUTF8('A37 C31974473C011D0014A 0141074922C'));
	    ...
	    $this->fpdf->Cell( 112  , 6 , setUTF8('') , 0, 0 , 'L' );
...
// 			$this->fpdf->SetDrawColor(255,4,0);
			$this->fpdf->SetY(8);
			$this->fpdf->SetX(42);
			$this->fpdf->Line(41,8,81,8);
			$this->fpdf->Line(41,15,81,15);
	    ...
	    $this->fpdf->Ln();
	    $this->fpdf->SetY(18+5);
	    $this->fpdf->Cell( 23  , 6 , setUTF8('') , 0, 0 , 'L' );
	    $this->fpdf->Cell( 125  , 6 , setUTF8($cheque_name) , 0, 0 , 'L' );
	    $this->fpdf->Ln();
	    $this->fpdf->SetY(26+5);
	    $this->fpdf->Cell( 23  , 6 , setUTF8('') , 0, 0 , 'L' );
	    $this->fpdf->Cell( 125  , 6 , setUTF8('** '.thaitext($cheque['cheque_amount']).' **') , 0, 0 , 'L' );
	    $this->fpdf->SetFont('brow','B',18);
	    $this->fpdf->Ln();
	    $this->fpdf->SetY(37);
