...
class Print_pv extends CI_Model
{
    ...
    public function make($cheque_id)
    {
        ...
        $this->fpdf->Cell(180, 15, setUTF8('AT FIRST BYTE CO., LTD.'), 'TRL', 1, 'C');
        $this->fpdf->SetFont('sukhumvitset', 'B', 16);
        $this->fpdf->Cell(180, 8, setUTF8('ใบสำคัญจ่าย (PV.)'), 'RL', 1, 'C');
        ...
        $this->fpdf->Image('public/sig-wannisa.png', 28, 265, 20.125, 8.25);
