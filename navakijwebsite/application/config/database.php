...
// $db['development']['hostname'] = '183.90.173.34';
// $db['development']['username'] = 'ted_navakij';
// $db['development']['password'] = 'LPVR4pOK';
$db['development']['hostname'] = 'navakij-dev-db';
$db['development']['username'] = 'navakij_db';
$db['development']['password'] = 'F8tq93pWz4BcKdX2';
$db['development']['database'] = 'navakij_db';
$db['development']['dbdriver'] = 'mysqli';
$db['development']['dbprefix'] = '';
$db['development']['pconnect'] = TRUE;
$db['development']['db_debug'] = TRUE;
$db['development']['cache_on'] = FALSE;
$db['development']['cachedir'] = './application/cache/';
