...
<section id="page-body" class="bg-lightgrey">
    <div class="container px-0">
        ...
        <div class="d-flex flex-wrap">
            ...
            <form id="applicantForm" name="applicantForm" method="post" enctype="multipart/form-data" action="" class="form col-12 col-lg-8 mx-auto">
                ...
                <div class="step-item step-1 active">
                    ...
                    <div class="wrapper border border-1px border-navy pb-3">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex align-items-center">
                                <input type="text" name="applicant_salary" id="applicant_salary" value="<?php echo set_value('applicant_salary', $info['applicant_salary']); ?>" placeholder="<?php echo $this->lang->line('Baht'); ?>" class="col-8" />
                    ...
                    <div class="wrapper border border-1px border-navy pb-3">
                                    ...
                                    <select name="prefix_id" id="prefix_id" class="select2">
                                        ...
                                        <?php if( isset( $prefixes ) && count( $prefixes ) > 0 ): ?>
                                            <?php foreach( $prefixes as $prefix ): ?>
                                                <option value="<?php echo $prefix['prefix_id']; ?>" <?php echo set_select('prefix_id', $prefix['prefix_id'], $info['prefix_id'] == $prefix['prefix_id']); ?>><?php echo $prefix['prefix_title_'.$this->_language]; ?></option>
                                            <?php endforeach; ?>
                                            <option value="999" <?php echo set_select('prefix_id', 999, $info['prefix_id'] == 999); ?>><?php echo $this->lang->line('Prefix Other'); ?></option>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                <div id="prefix_other_box" class="col-12 px-0 col-lg-4 <?php echo ( $info['prefix_id'] != 999 ? 'd-none' : '' ); ?>">
                                    <input type="text" name="prefix_other" id="prefix_other" value="<?php echo set_value('prefix_other', $info['prefix_other']); ?>" placeholder="<?php echo $this->lang->line('Prefix Other'); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex flex-wrap">
                                <div class="col-12 px-0 pr-lg-3 col-lg-6 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_fname_th" id="applicant_fname_th" value="<?php echo set_value('applicant_fname_th', $info['applicant_fname_th']); ?>" placeholder="<?php echo $this->lang->line('First name TH'); ?>" class="required" />
                                </div>
                                <div class="col-12 px-0 pl-lg-3 col-lg-6">
                                    <input type="text" name="applicant_lname_th" id="applicant_lname_th" value="<?php echo set_value('applicant_lname_th', $info['applicant_lname_th']); ?>" placeholder="<?php echo $this->lang->line('Last name TH'); ?>" class="required" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex flex-wrap">
                                <div class="col-12 px-0 pr-lg-3 col-lg-6 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_fname_en" id="applicant_fname_en" value="<?php echo set_value('applicant_fname_en', $info['applicant_fname_en']); ?>" placeholder="<?php echo $this->lang->line('First name EN'); ?>" class="required" />
                                </div>
                                <div class="col-12 px-0 pl-lg-3 col-lg-6">
                                    <input type="text" name="applicant_lname_en" id="applicant_lname_en" value="<?php echo set_value('applicant_lname_en', $info['applicant_lname_en']); ?>" placeholder="<?php echo $this->lang->line('Last name EN'); ?>" class="required" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="icon-append position-relative col-12 px-0 col-lg-4">
                                    ...
                                    <input type="text" name="applicant_birthdate" id="applicant_birthdate" value="<?php echo set_value('applicant_birthdate', date('d-m-Y', strtotime( $info['applicant_birthdate'] ))); ?>" class="date-picker" readonly />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <input type="text" name="applicant_idcard" id="applicant_idcard" value="<?php echo set_value('applicant_idcard', $info['applicant_idcard']); ?>" class="required validate_number_only" maxlength="13" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="icon-append position-relative col-12 px-0 col-lg-4">
                                    <i class="fas fa-calendar-o grey position-absolute"></i>
                                    <input type="text" name="applicant_idcard_expired" id="applicant_idcard_expired" value="<?php echo set_value('applicant_idcard_expired', $info['applicant_idcard_expired']); ?>" class="date-picker" readonly />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex align-items-center">
                                <div class="col-10 px-0 col-lg-3">
                                    <input type="number" name="applicant_height" id="applicant_height" value="<?php echo set_value('applicant_height', $info['applicant_height']); ?>" min="0" max="999" step="1" />
                                </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex align-items-center">
                                <div class="col-10 px-0 col-lg-3">
                                    <input type="number" name="applicant_weight" id="applicant_weight" value="<?php echo set_value('applicant_weight', $info['applicant_weight']); ?>" min="0" max="9999" step="1" />
                                </div>
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <select name="applicant_military_status" id="applicant_military_status" class="select2">
                                        <option value="0" <?php echo set_select('applicant_military_status',0, ( !$info['applicant_military_status'] || $info['applicant_military_status'] == 0 ? 'selected' : '' )); ?>>-- <?php echo $this->lang->line('Choose, military status'); ?> --</option>
                                        <option value="serving" <?php echo set_select('applicant_military_status', 'serving', $info['applicant_military_status'] == 'serving'); ?>><?php echo $this->lang->line('Serving'); ?></option>
                                        <option value="completed" <?php echo set_select('applicant_military_status', 'completed', $info['applicant_military_status'] == 'completed' ); ?>><?php echo $this->lang->line('Completed'); ?></option>
                                        <option value="exempted" <?php echo set_select('applicant_military_status', 'exempted', $info['applicant_military_status'] == 'exempted'); ?>><?php echo $this->lang->line('Exempted'); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="wrapper border border-1px border-navy pb-3">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <input type="text" name="applicant_current_address_no" id="applicant_current_address_no" value="<?php echo set_value('applicant_current_address_no', $current['address_no']); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <input type="text" name="applicant_current_village" id="applicant_current_village" value="<?php echo set_value('applicant_current_village', $current['address_building']); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <input type="text" name="applicant_current_avenue" id="applicant_current_avenue" value="<?php echo set_value('applicant_current_avenue', $current['address_avenue']); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <input type="text" name="applicant_current_road" id="applicant_current_road" value="<?php echo set_value('applicant_current_road', $current['address_street']); ?>" />
                                </div>
                            </div>
                        </div>
                                    ...
                                    <select name="applicant_current_province_id" id="applicant_current_province_id" class="select2">
                                        ...
                                        <?php if( isset( $provinces ) && count( $provinces ) > 0 ): ?>
                                            <?php foreach( $provinces as $province ): ?>
                                                <option value="<?php echo $province['province_id']; ?>" <?php echo set_select('applicant_current_province_id', $province['province_id'], $current['province_id'] == $province['province_id']); ?>><?php echo ( $this->_language == 'th' ? $province['name'] : $province['name_alt'] ); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <select name="applicant_current_district_id" id="applicant_current_district_id" class="select2">
                                        ...
                                        <?php $districts = $this->jobsmodel->get_districts( $current['district_id'] ); ?>
                                        <?php if( isset( $districts ) && count( $districts ) > 0 ): ?>
                                            <?php foreach( $districts as $district ): ?>
                                                <option value="<?php echo $district['amphoe_id']; ?>" <?php echo set_select('applicant_current_district_id;', $district['amphoe_id'], $current['district_id'] == $district['amphoe_id']); ?>><?php echo ( $this->_language == 'th' ? $district['name'] : $district['name_alt'] ); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <select name="applicant_current_subdistrict_id" id="applicant_current_subdistrict_id" class="select2">
                                        ...
                                        <?php $subdistricts = $this->jobsmodel->get_subdistricts( $current['subdistrict_id'] ); ?>
                                        <?php if( isset( $subdistricts ) && count( $subdistricts ) > 0 ): ?>
                                            <?php foreach( $subdistricts as $subdistrict ): ?>
                                                <option value="<?php echo $subdistrict['tambon_id']; ?>" <?php echo set_select('applicant_current_subdistrict_id', $subdistrict['tambon_id'], $current['subdistrict_id'] == $subdistrict['tambon_id']); ?>><?php echo ( $this->_language == 'th' ? $subdistrict['name'] : $subdistrict['name_alt'] ); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <select name="applicant_current_postcode_id" id="applicant_current_postcode_id" class="select2">
                                        ...
                                        <?php $postcodes = $this->jobsmodel->get_zipcodes( $current['postcode_id'] ); ?>
                                        <?php if( isset( $postcodes ) && count( $postcodes ) > 0 ): ?>
                                            <?php foreach( $postcodes as $postcode ): ?>
                                                <option value="<?php echo $postcode['postcode_id']; ?>" <?php echo set_select('applicant_current_postcode_id', $postcode['postcode_id'], $current['postcode_id'] == $postcode['postcode_id']); ?>><?php echo $postcode['postcode']; ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <input type="tel" name="applicant_current_telephone" id="applicant_current_telephone" value="<?php echo set_value('applicant_current_telephone', $current['address_tel']); ?>" maxlength="10" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <input type="tel" name="applicant_current_mobile" id="applicant_current_mobile" value="<?php echo set_value('applicant_current_mobile', $current['address_mobile']); ?>" class="required validate_mobile" maxlength="10" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="col-12 px-0 col-lg-8">
                                    <input type="email" name="applicant_current_email" id="applicant_current_email" value="<?php echo set_value('applicant_current_email', $current['address_email']); ?>" class="required validate_email" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="wrapper border border-1px border-navy pb-3">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="applicant_register_same_address">
                                <input type="checkbox" name="applicant_register_same_address" id="applicant_register_same_address" value="1" <?php echo set_checkbox('applicant_register_same_address', 1); ?> /> <?php echo $this->lang->line('Use same as present address'); ?>
                            </label>
                        </div>
                        */ ?>
                        ...
                        <div id="different_address">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <input type="text" name="applicant_register_address_no" id="applicant_register_address_no" value="<?php echo set_value('applicant_register_address_no', $registration['address_no']); ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <input type="text" name="applicant_register_village" id="applicant_register_village" value="<?php echo set_value('applicant_register_village', $registration['address_building']); ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <input type="text" name="applicant_register_avenue" id="applicant_register_avenue" value="<?php echo set_value('applicant_register_avenue', $registration['address_avenue']); ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <input type="text" name="applicant_register_road" id="applicant_register_road" value="<?php echo set_value('applicant_register_road', $registration['address_street']); ?>" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <select name="applicant_register_province_id" id="applicant_register_province_id" class="select2">
                                            ...
                                            <?php if( isset( $provinces ) && count( $provinces ) > 0 ): ?>
                                                <?php foreach( $provinces as $province ): ?>
                                                    <option value="<?php echo $province['province_id']; ?>" <?php echo set_select('applicant_register_province_id', $province['province_id'], $registration['province_id'] == $province['province_id']); ?>><?php echo ( $this->_language == 'th' ? $province['name'] : $province['name_alt'] ); ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <select name="applicant_register_district_id" id="applicant_register_district_id" class="select2">
                                            ...
                                            <?php $districts = $this->jobsmodel->get_districts( $registration['district_id'] ); ?>
                                            <?php if( isset( $districts ) && count( $districts ) > 0 ): ?>
                                                <?php foreach( $districts as $district ): ?>
                                                    <option value="<?php echo $district['amphoe_id']; ?>" <?php echo set_select('applicant_register_district_id;', $district['amphoe_id'], $registration['district_id'] == $district['amphoe_id']); ?>><?php echo ( $this->_language == 'th' ? $district['name'] : $district['name_alt'] ); ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <select name="applicant_register_subdistrict_id" id="applicant_register_subdistrict_id" class="select2">
                                            ...
                                            <?php $subdistricts = $this->jobsmodel->get_subdistricts( $registration['subdistrict_id'] ); ?>
                                            <?php if( isset( $subdistricts ) && count( $subdistricts ) > 0 ): ?>
                                                <?php foreach( $subdistricts as $subdistrict ): ?>
                                                    <option value="<?php echo $subdistrict['tambon_id']; ?>" <?php echo set_select('applicant_register_subdistrict_id', $subdistrict['tambon_id'], $registration['subdistrict_id'] == $subdistrict['tambon_id']); ?>><?php echo ( $this->_language == 'th' ? $subdistrict['name'] : $subdistrict['name_alt'] ); ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <select name="applicant_register_postcode_id" id="applicant_register_postcode_id" class="select2">
                                            ...
                                            <?php $postcodes = $this->jobsmodel->get_zipcodes( $registration['postcode_id'] ); ?>
                                            <?php if( isset( $postcodes ) && count( $postcodes ) > 0 ): ?>
                                                <?php foreach( $postcodes as $postcode ): ?>
                                                    <option value="<?php echo $postcode['postcode_id']; ?>" <?php echo set_select('applicant_register_postcode_id', $postcode['postcode_id'], $registration['postcode_id'] == $postcode['postcode_id']); ?>><?php echo $postcode['postcode']; ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <input type="tel" name="applicant_register_telephone" id="applicant_register_telephone" value="<?php echo set_value('applicant_register_telephone', $registration['address_tel']); ?>" maxlength="10" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls d-flex">
                                    <div class="col-12 px-0 col-lg-8">
                                        <input type="tel" name="applicant_register_mobile" id="applicant_register_mobile" value="<?php echo set_value('applicant_register_mobile', $registration['address_mobile']); ?>" class="validate_mobile" maxlength="10" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="col-12 px-0 col-lg-8">
                                        <input type="email" name="applicant_register_email" id="applicant_register_email" value="<?php echo set_value('applicant_register_email', $registration['address_email']); ?>" class="validate_email" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="wrapper border border-1px border-navy pb-3">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <select name="applicant_news_source_id" id="applicant_news_source_id" class="select2">
                                        <option value="0" <?php echo set_select('applicant_news_source_id', '', ( $info['applicant_news_source_id'] == '' || !$info['applicant_news_source_id'] ? 'selected' : '' )); ?>>-- <?php echo $this->lang->line('Choose option'); ?> --</option>
                                        <?php if( isset( $sources ) && count( $sources ) > 0 ): ?>
                                            <?php foreach( $sources as $source ): ?>
                                                <option value="<?php echo $source['source_id']; ?>" <?php echo set_select('applicant_news_source_id', $source['source_id'], $info['applicant_news_source_id'] == $source['source_id']); ?>><?php echo $source['source_title_'.$this->_language]; ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex align-items-center">
                                <label class="col"><input type="checkbox" name="applicant_applied_status" id="applicant_applied_status" value="1" <?php echo set_checkbox('applicant_applied_status', 1, $info['applicant_applied_status'] == 1); ?> class="mr-2" /> <?php echo $this->lang->line('Yes'); ?></label>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-4">
                                    <input type="text" name="applicant_applied_year" id="applicant_applied_year" value="<?php echo set_value('applicant_applied_year', $info['applicant_applied_year']); ?>" placeholder="<?php echo $this->lang->line('Year'); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <label for="applicant_accident_status" class="col"><input type="checkbox" name="applicant_accident_status" id="applicant_accident_status" value="1" <?php echo set_checkbox('applicant_accident_status', 1, $info['applicant_accident_status'] == 1); ?> /> <?php echo $this->lang->line('Yes'); ?></label>
                            </div>
                        </div>
                ...
                <div class="step-item step-2">
                    ...
                    <div class="wrapper border border-1px border-navy pb-3">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex align-items-center">
                                <label for="applicant_studying_status" class="col"><input type="checkbox" name="applicant_studying_status" id="applicant_studying_status" value="1" <?php echo set_checkbox('applicant_studying_status', 1, $info['applicant_studying_status'] == 1); ?> /> <?php echo $this->lang->line('Yes'); ?></label>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0">
                                    <input type="text" name="applicant_education_highschool_name" id="applicant_education_highschool_name" value="<?php echo set_value('applicant_education_highschool_name', $info['applicant_education_highschool_name']); ?>" placeholder="<?php echo $this->lang->line('Stitution name'); ?>" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="controls d-flex flex-wrap align-items-center">
                                <div class="col-12 px-0 pr-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <select name="applicant_education_highschool_province_id" id="applicant_education_highschool_province_id" class="select2">
                                        ...
                                        <?php if( isset( $provinces ) && count( $provinces ) > 0 ): ?>
                                            <?php foreach( $provinces as $province ): ?>
                                                <option value="<?php echo $province['province_id']; ?>" <?php echo set_select('applicant_education_highschool_province_id', $province['province_id'], $info['applicant_education_highschool_province_id'] == $province['province_id']); ?>><?php echo ( $this->_language == 'th' ? $province['name'] : $province['name_alt'] ); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_highschool_year" id="applicant_education_highschool_year" value="<?php echo set_value('applicant_education_highschool_year', $info['applicant_education_highschool_year']); ?>" placeholder="<?php echo $this->lang->line('Educated Year'); ?>" />
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_highschool_major" id="applicant_education_highschool_major" value="<?php echo set_value('applicant_education_highschool_major', $info['applicant_education_highschool_major']); ?>" placeholder="<?php echo $this->lang->line('Major'); ?>" />
                                </div>
                                <div class="col-12 px-0 pl-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_highschool_gpa" id="applicant_education_highschool_gpa" value="<?php echo set_value('applicant_education_highschool_gpa', $info['applicant_education_highschool_gpa']); ?>" placeholder="<?php echo $this->lang->line('GPA'); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0">
                                    <input type="text" name="applicant_education_vocational_name" id="applicant_education_vocational_name" value="<?php echo set_value('applicant_education_vocational_name', $info['applicant_education_vocational_name']); ?>" placeholder="<?php echo $this->lang->line('Stitution name'); ?>" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="controls d-flex flex-wrap align-items-center">
                                <div class="col-12 px-0 pr-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <select name="applicant_education_vocational_province_id" id="applicant_education_vocational_province_id" class="select2">
                                        ...
                                        <?php if( isset( $provinces ) && count( $provinces ) > 0 ): ?>
                                            <?php foreach( $provinces as $province ): ?>
                                                <option value="<?php echo $province['province_id']; ?>" <?php echo set_select('applicant_education_vocational_province_id', $province['province_id'], $info['applicant_education_vocational_province_id'] == $province['province_id']); ?>><?php echo ( $this->_language == 'th' ? $province['name'] : $province['name_alt'] ); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_vocational_year" id="applicant_education_vocational_year" value="<?php echo set_value('applicant_education_vocational_year', $info['applicant_education_vocational_year']); ?>" placeholder="<?php echo $this->lang->line('Educated Year'); ?>" />
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_vocational_major" id="applicant_education_vocational_major" value="<?php echo set_value('applicant_education_vocational_major', $info['applicant_education_vocational_major']); ?>" placeholder="<?php echo $this->lang->line('Major'); ?>" />
                                </div>
                                <div class="col-12 px-0 pl-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_vocational_gpa" id="applicant_education_vocational_gpa" value="<?php echo set_value('applicant_education_vocational_gpa', $info['applicant_education_vocational_gpa']); ?>" placeholder="<?php echo $this->lang->line('GPA'); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0">
                                    <input type="text" name="applicant_education_diploma_name" id="applicant_education_diploma_name" value="<?php echo set_value('applicant_education_diploma_name', $info['applicant_education_diploma_name']); ?>" placeholder="<?php echo $this->lang->line('Stitution Name'); ?>" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="controls d-flex flex-wrap align-items-center">
                                <div class="col-12 px-0 pr-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <select name="applicant_education_diploma_province_id" id="applicant_education_diploma_province_id" class="select2">
                                        ...
                                        <?php if( isset( $provinces ) && count( $provinces ) > 0 ): ?>
                                            <?php foreach( $provinces as $province ): ?>
                                                <option value="<?php echo $province['province_id']; ?>" <?php echo set_select('applicant_education_diploma_province_id', $province['province_id'], $info['applicant_education_diploma_province_id'] == $province['province_id']); ?>><?php echo ( $this->_language == 'th' ? $province['name'] : $province['name_alt'] ); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_diploma_year" id="applicant_education_diploma_year" value="<?php echo set_value('applicant_education_diploma_year', $info['applicant_education_diploma_year']); ?>" placeholder="<?php echo $this->lang->line('Educated Year'); ?>" />
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_diploma_major" id="applicant_education_diploma_major" value="<?php echo set_value('applicant_education_diploma_major', $info['applicant_education_diploma_major']); ?>" placeholder="<?php echo $this->lang->line('Major'); ?>" />
                                </div>
                                <div class="col-12 px-0 pl-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_diploma_gpa" id="applicant_education_diploma_gpa" value="<?php echo set_value('applicant_education_diploma_gpa', $info['applicant_education_diploma_gpa']); ?>" placeholder="<?php echo $this->lang->line('GPA'); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0">
                                    <input type="text" name="applicant_education_bachelor_name" id="applicant_education_bachelor_name" value="<?php echo set_value('applicant_education_bachelor_name', $info['applicant_education_bachelor_name']); ?>" placeholder="<?php echo $this->lang->line('Stitution Name'); ?>" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="controls d-flex flex-wrap align-items-center">
                                <div class="col-12 px-0 pr-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <select name="applicant_education_bachelor_province_id" id="applicant_education_bachelor_province_id" class="select2">
                                        ...
                                        <?php if( isset( $provinces ) && count( $provinces ) > 0 ): ?>
                                            <?php foreach( $provinces as $province ): ?>
                                                <option value="<?php echo $province['province_id']; ?>" <?php echo set_select('applicant_education_bachelor_province_id', $province['province_id'], $info['applicant_education_bachelor_province_id'] == $province['province_id']); ?>><?php echo ( $this->_language == 'th' ? $province['name'] : $province['name_alt'] ); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_bachelor_year" id="applicant_education_bachelor_year" value="<?php echo set_value('applicant_education_bachelor_year', $info['applicant_education_bachelor_year']); ?>" placeholder="<?php echo $this->lang->line('Educated Year'); ?>" />
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-4 mb-3 mb-lg-0">
                                ...
                                <div class="col-12 px-0 pl-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_bachelor_gpa" id="applicant_education_bachelor_gpa" value="<?php echo set_value('applicant_education_bachelor_gpa', $info['applicant_education_bachelor_gpa']); ?>" placeholder="<?php echo $this->lang->line('GPA'); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0">
                                    <input type="text" name="applicant_education_master_name" id="applicant_education_master_name" value="<?php echo set_value('applicant_education_master_name', $info['applicant_education_master_name']); ?>" placeholder="<?php echo $this->lang->line('Stitution Name'); ?>" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="controls d-flex flex-wrap align-items-center">
                                <div class="col-12 px-0 pr-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <select name="applicant_education_master_province_id" id="applicant_education_master_province_id" class="select2">
                                        ...
                                        <?php if( isset( $provinces ) && count( $provinces ) > 0 ): ?>
                                            <?php foreach( $provinces as $province ): ?>
                                                <option value="<?php echo $province['province_id']; ?>" <?php echo set_select('applicant_education_master_province_id', $province['province_id'], $info['applicant_education_master_province_id'] == $province['province_id']); ?>><?php echo ( $this->_language == 'th' ? $province['name'] : $province['name_alt'] ); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_master_year" id="applicant_education_master_year" value="<?php echo set_value('applicant_education_master_year', $info['applicant_education_master_year']); ?>" placeholder="<?php echo $this->lang->line('Educated Year'); ?>" />
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_master_major" id="applicant_education_master_major" value="<?php echo set_value('applicant_education_master_major', $info['applicant_education_master_major']); ?>" placeholder="<?php echo $this->lang->line('Major'); ?>" />
                                </div>
                                <div class="col-12 px-0 pl-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_master_gpa" id="applicant_education_master_gpa" value="<?php echo set_value('applicant_education_master_gpa', $info['applicant_education_master_gpa']); ?>" placeholder="<?php echo $this->lang->line('GPA'); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0">
                                    <input type="text" name="applicant_education_other_name" id="applicant_education_other_name" value="<?php echo set_value('applicant_education_other_name', $info['applicant_education_other_name']); ?>" placeholder="<?php echo $this->lang->line('Stitution Name'); ?>" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="controls d-flex flex-wrap align-items-center">
                                <div class="col-12 px-0 pr-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <select name="applicant_education_other_province_id" id="applicant_education_other_province_id" class="select2">
                                        ...
                                        <?php if( isset( $provinces ) && count( $provinces ) > 0 ): ?>
                                            <?php foreach( $provinces as $province ): ?>
                                                <option value="<?php echo $province['province_id']; ?>" <?php echo set_select('applicant_education_other_province_id', $province['province_id'], $info['applicant_education_other_province_id'] == $province['province_id']); ?>><?php echo ( $this->_language == 'th' ? $province['name'] : $province['name_alt'] ); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_other_year" id="applicant_education_other_year" value="<?php echo set_value('applicant_education_other_year', $info['applicant_education_other_year']); ?>" placeholder="<?php echo $this->lang->line('Educated Year'); ?>" />
                                </div>
                                <div class="col-12 px-0 px-lg-3 col-lg-4 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_other_major" id="applicant_education_other_major" value="<?php echo set_value('applicant_education_other_major', $info['applicant_education_other_major']); ?>" placeholder="<?php echo $this->lang->line('Major'); ?>" />
                                </div>
                                <div class="col-12 px-0 pl-lg-3 col-lg-2 mb-3 mb-lg-0">
                                    <input type="text" name="applicant_education_other_gpa" id="applicant_education_other_gpa" value="<?php echo set_value('applicant_education_other_gpa', $info['applicant_education_other_gpa']); ?>" placeholder="<?php echo $this->lang->line('GPA'); ?>" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="wrapper border border-1px border-navy pb-3">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <textarea name="applicant_skill_computer" id="applicant_skill_computer" rows="5"><?php echo set_value('applicant_skill_computer', $info['applicant_skill_computer']); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex align-items-center">
                                <div class="col-10 px-0 col-lg-3">
                                    <input type="number" name="applicant_skill_typing_thai" id="applicant_skill_typing_thai" value="<?php echo set_value('applicant_skill_typing_thai', $info['applicant_skill_typing_thai']); ?>" step="1" min="0" max="999" />
                                </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex align-items-center">
                                <div class="col-10 px-0 col-lg-3">
                                    <input type="number" name="applicant_skill_typing_english" id="applicant_skill_typing_english" value="<?php echo set_value('applicant_skill_typing_english', $info['applicant_skill_typing_english']); ?>" step="1" min="0" max="999" />
                                </div>
                                <span class="help-inline ml-1 ml-lg-3"><?php echo $this->lang->line('word/minute'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <textarea name="applicant_skill_office_tools" id="applicant_skill_office_tools" rows="5"><?php echo set_value('applicant_skill_office_tools', $info['applicant_skill_office_tools']); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <textarea name="applicant_skill_specials" id="applicant_skill_specials" rows="5"><?php echo set_value('applicant_skill_specials', $info['applicant_skill_specials']); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex">
                                <div class="col-12 px-0 col-lg-8">
                                    <textarea name="applicant_skill_activities" id="applicant_skill_activities" rows="5"><?php echo set_value('applicant_skill_activities', $info['applicant_skill_activities']); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls d-flex flex-wrap">
                                <p class="col-12 px-0 d-flex flex-wrap align-items-center mb-3"><input type="checkbox" name="applicant_skill_driving_status" id="applicant_skill_driving_status" value="1" <?php echo set_checkbox('applicant_skill_driving_status', 1); ?> class="mr-3" /> <?php echo $this->lang->line('Yes, I can drive'); ?> <input type="text" name="applicant_skill_driving_license" id="applicant_skill_driving_license" value="<?php echo set_value('applicant_skill_driving_license', $info['applicant_skill_driving_status'] == 1); ?>" placeholder="<?php echo $this->lang->line('License Number'); ?>" class="col-12 px-0 mb-3 mb-lg-0 col-lg-4 ml-lg-3" /></p>
                                <p class="col-12 px-0 d-flex flex-wrap align-items-center"><input type="checkbox" name="applicant_skill_riding_status" id="applicant_skill_riding_status" value="1" <?php echo set_checkbox('applicant_skill_riding_status', 1); ?> class="mr-3" /> <?php echo $this->lang->line('Yes, I can ride'); ?> <input type="text" name="applicant_skill_riding_license" id="applicant_skill_riding_license" value="<?php echo set_value('applicant_skill_riding_license', $info['applicant_skill_riding_license'] == 1); ?>" placeholder="<?php echo $this->lang->line('License Number'); ?>" class="col-12 px-0 mb-3 mb-lg-0 col-lg-4 ml-lg-3" /></p>
                            </div>
                        </div>
                                ...
                                <?php foreach( $languages as $language ): ?>
                                    <div class="language-skill-item control-group pb-3">
                                        <label class="control-label">
                                            <?php if( $language['language_name'] == 'Thai' ): ?>
                                                <?php echo ( $this->_language == 'th' ? 'ไทย' : 'Thai' ); ?>
                                            <?php elseif( $language['language_name'] == 'English' ): ?>
                                                <?php echo ( $this->_language == 'th' ? 'อังกฤษ' : 'English' ); ?>
                                            <?php else: ?>
                                                <?php echo $language['language_name']; ?>
                                            <?php endif; ?>
                                            <input type="hidden" name="applicant_skill_languages[name][]" value="<?php echo $language['language_name']; ?>" />
                                        </label>
                                        <div class="controls d-flex flex-wrap">
                                            <div class="col-12 px-0 pr-lg-3 col-lg-3 mb-3 mb-lg-0">
                                                <select name="applicant_skill_languages[listen][]">
                                                    <option value="0" <?php echo set_select('applicant_skill_languages[listen][]',0, !$language['language_listen']); ?>>-- <?php echo $this->lang->line('Choose listening level'); ?> --</option>
                                                    <option value="great" <?php echo set_select('applicant_skill_languages[listen][]', 'great', $language['language_listen'] == 'great'); ?>><?php echo $this->lang->line('Language skill : great'); ?></option>
                                                    <option value="good" <?php echo set_select('applicant_skill_languages[listen][]', 'good', $language['language_listen'] == 'good'); ?>><?php echo $this->lang->line('Language skill : good'); ?></option>
                                                    <option value="moderate" <?php echo set_select('applicant_skill_languages[listen][]', 'moderate', $language['language_listen'] == 'moderate'); ?>><?php echo $this->lang->line('Language skill : moderate'); ?></option>
                                                </select>
                                            </div>
                                            <div class="col-12 px-0 px-lg-3 col-lg-3 mb-3 mb-lg-0">
                                                <select name="applicant_skill_languages[speaking][]">
                                                    <option value="0" <?php echo set_select('applicant_skill_languages[speaking][]',0, !$language['language_speaking']); ?>>-- <?php echo $this->lang->line('Choose speaking level'); ?> --</option>
                                                    <option value="great" <?php echo set_select('applicant_skill_languages[speaking][]', 'great', $language['language_speaking'] == 'great'); ?>><?php echo $this->lang->line('Language skill : great'); ?></option>
                                                    <option value="good" <?php echo set_select('applicant_skill_languages[speaking][]', 'good', $language['language_speaking'] == 'good'); ?>><?php echo $this->lang->line('Language skill : good'); ?></option>
                                                    <option value="moderate" <?php echo set_select('applicant_skill_languages[speaking][]', 'moderate', $language['language_speaking'] == 'moderate'); ?>><?php echo $this->lang->line('Language skill : moderate'); ?></option>
                                                </select>
                                            </div>
                                            <div class="col-12 px-0 px-lg-3 col-lg-3 mb-3 mb-lg-0">
                                                <select name="applicant_skill_languages[reading][]">
                                                    <option value="0" <?php echo set_select('applicant_skill_languages[reading][]',0, !$language['language_reading']); ?>>-- <?php echo $this->lang->line('Choose reading level'); ?> --</option>
                                                    <option value="great" <?php echo set_select('applicant_skill_languages[reading][]', 'great', $language['language_reading'] == 'great'); ?>><?php echo $this->lang->line('Language skill : great'); ?></option>
                                                    <option value="good" <?php echo set_select('applicant_skill_languages[reading][]', 'good', $language['language_reading'] == 'good'); ?>><?php echo $this->lang->line('Language skill : good'); ?></option>
                                                    <option value="moderate" <?php echo set_select('applicant_skill_languages[reading][]', 'moderate', $language['language_reading'] == 'moderate'); ?>><?php echo $this->lang->line('Language skill : moderate'); ?></option>
                                                </select>
                                            </div>
                                            <div class="col-12 px-0 pl-lg-3 col-lg-3 mb-3 mb-lg-0">
                                                <select name="applicant_skill_languages[writing][]">
                                                    <option value="0" <?php echo set_select('applicant_skill_languages[writing][]',0, !$language['language_writing']); ?>>-- <?php echo $this->lang->line('Choose writing level'); ?> --</option>
                                                    <option value="great" <?php echo set_select('applicant_skill_languages[writing][]', 'great', $language['language_writing'] == 'great'); ?>><?php echo $this->lang->line('Language skill : great'); ?></option>
                                                    <option value="good" <?php echo set_select('applicant_skill_languages[writing][]', 'good', $language['language_writing'] == 'good'); ?>><?php echo $this->lang->line('Language skill : good'); ?></option>
                                                    <option value="moderate" <?php echo set_select('applicant_skill_languages[writing][]', 'moderate', $language['language_writing'] == 'moderate'); ?>><?php echo $this->lang->line('Language skill : moderate'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="step-item step-3">
                    ...
                    <div class="wrapper border border-1px border-navy pb-3">
                        ...
                        <div id="experiences">
                                    ...
                                    <div class="experience-item px-3 my-3 position-relative">
                                        ...
                                        <div class="collapse <?php echo ( $i == 1 ? 'show' : '' ); ?>" id="experience-item-<?php echo $i; ?>" data-parent="#experiences">
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex">
                                                    <div class="col-12 px-0 col-lg-8">
                                                        <input type="text" name="applicant_experiences[company_name][]" value="<?php echo set_value('applicant_experiences[company_name][]', $experience['experience_company_name']); ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex">
                                                    <div class="col-12 px-0 col-lg-8">
                                                        <textarea name="applicant_experiences[company_address][]" rows="5"><?php echo set_value('applicant_experiences[company_address][]', $experience['experience_company_address']); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex">
                                                    <div class="col-12 px-0 col-lg-8">
                                                        <input type="tel" name="applicant_experiences[company_tel][]" value="<?php echo set_value('applicant_experiences[company_tel][]', $experience['experience_company_tel']); ?>" maxlength="10" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex flex-wrap align-items-center">
                                                    <div class="col-12 px-0 col-lg-4 mb-3 mb-lg-0">
                                                        <input type="text" name="applicant_experiences[start][]" value="<?php echo set_value('applicant_experiences[start][]', ( $experience['experience_start'] != '' ? date( 'd-m-Y', strtotime( $experience['experience_start'] ) ) : '' )); ?>" class="date-picker" placeholder="<?php echo $this->lang->line('Start'); ?>" />
                                                    </div>
                                                    <span class="col-12 col-lg-1 px-0 px-lg-3 mb-3 mb-lg-0 text-center">To</span>
                                                    <div class="col-12 px-0 col-lg-4">
                                                        <input type="text" name="applicant_experiences[end][]" value="<?php echo set_value('applicant_experiences[end][]', ( $experience['experience_end'] != '' ? date( 'd-m-Y', strtotime( $experience['experience_end'] ) ) : '' )); ?>" class="date-picker" placeholder="<?php echo $this->lang->line('To'); ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex">
                                                    <div class="col-12 px-0 col-lg-8">
                                                        <input type="text" name="applicant_experiences[superior][]" value="<?php echo set_value('applicant_experiences[superior][]', $experience['experience_superior']); ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex">
                                                    <div class="col-12 px-0 col-lg-8">
                                                        <textarea name="applicant_experiences[responsibility][]" rows="5"><?php echo set_value('applicant_experiences[responsibility][]', $experience['experience_job_description']); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex align-items-center">
                                                    <div class="col-10 px-0 col-lg-8">
                                                        <input type="number" name="applicant_experiences[salary][]" value="<?php echo set_value('applicant_experiences[salary][]', $experience['experience_salary']); ?>" step="1" min="0" max="9999999" />
                                                    </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex align-items-center">
                                                    <div class="col-10 px-0 col-lg-8">
                                                        <input type="number" name="applicant_experiences[cost_of_living][]" value="<?php echo set_value('applicant_experiences[cost_of_living][]', $experience['experience_cost_of_living']); ?>" step="1" min="0" max="9999999" />
                                                    </div>
                                                    <span class="help-inline pl-2"><?php echo $this->lang->line('Baht'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex align-items-center">
                                                    <div class="col-10 px-0 col-lg-8">
                                                        <input type="number" name="applicant_experiences[bonus][]" value="<?php echo set_value('applicant_experiences[bonus][]', $experience['experience_bonus']); ?>" step="1" min="0" max="9999999" />
                                                    </div>
                                                    <span class="help-inline pl-2"><?php echo $this->lang->line('Baht'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex align-items-center">
                                                    <div class="col-10 px-0 col-lg-8">
                                                        <input type="number" name="applicant_experiences[other][]" value="<?php echo set_value('applicant_experiences[other][]', $experience['experience_other']); ?>" step="1" min="0" max="9999999" />
                                                    </div>
                                                    <span class="help-inline pl-2"><?php echo $this->lang->line('Baht'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex align-items-center">
                                                    <div class="col-10 px-0 col-lg-8">
                                                        <input type="number" name="applicant_experiences[total][]" value="<?php echo set_value('applicant_experiences[total][]', $experience['experience_total']); ?>" step="0" min="0" max="9999999" />
                                                    </div>
                                                    <span class="help-inline pl-2"><?php echo $this->lang->line('Baht'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group px-0">
                                                ...
                                                <div class="controls d-flex align-items-center">
                                                    <div class="col-12 px-0 col-lg-8">
                                                        <textarea name="applicant_experiences[reason][]" rows="5"><?php echo set_value('applicant_experiences[reason][]', $experience['experience_reason']); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <?php else: ?>
                                <div class="experience-item px-3 my-3 position-relative">
                                    <a href="#experience-item-1" data-toggle="collapse" role="button" aria-expended="true" aria-controls="experience-1" class="btn btn-navy w-100">
                                        <?php echo $this->lang->line('company'); ?> <span class="number">1</span>
                                    </a>
                                    <div class="collapse show" id="experience-item-1" data-parent="#experiences">
                                        ...
                                        <div class="control-group px-0">
                                            <label class="control-label"><?php echo $this->lang->line('Period'); ?></label>
                                            <div class="controls d-flex align-items-center">
                                                <div class="col-10 col-lg-4 mb-3 mb-lg-0">
