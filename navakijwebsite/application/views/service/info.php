        ...
        <div class="d-flex flex-wrap">
            ...
            <div id="breadcrumb" class="breadcrumb col-12 px-0 px-md-3 mb-3">
                <p>
                    ...
                    <a href="<?php echo site_url('nki-services/'.$category['category_meta_url']); ?>" class="btn-text black"><?php echo $category['category_title_'.$this->_language]; ?></a>
                    <a href="<?php echo site_url('nki-services/'.$info['article_meta_url']); ?>" class="btn-text navy"><?php echo $info['article_title_'.$this->_language]; ?></a>
                </p>
            </div>

            <div class="col-12 px-0 px-md-3 mb-3 mt-5">
                <h4 class="navy"><?php echo $info['article_title_'.$this->_language]; ?></h4>
            </div>
            ...
            <div class="col-12 mt-3 text-center">
                <p class="my-3"><a href="<?php echo site_url('nki-services/'.$category['category_meta_url']); ?>" class="btn btn-lg btn-icon btn-navy-transparent"><i class="fas fa-chevron-left"></i> กลับ</a></p>
            </div>
