    ...
    <div class="d-flex flex-wrap">
      ...
      <div id="breadcrumb" class="breadcrumb col-12 px-0 px-md-3 mb-3">
        <p>
          ...
          <a href="<?php echo site_url( $maincategory['category_meta_url'] ); ?>" class="btn-text black"><?php echo $maincategory['category_title_'.$this->_language]; ?></a>
          <a href="<?php echo site_url( $maincategory['category_meta_url'].'/'.$category['category_meta_url'] ); ?>" class="btn-text navy"><?php echo $category['category_title_'.$this->_language]; ?></a>
        </p>
      </div>
              ...
              <div class="item w-100 d-flex flex-wrap">
                ...
                <?php if($document['document_type'] == "multi"): ?>
                  <div id="files-<?php echo $document['document_id']; ?>" class="collapse multi-collapse col-12 px-0">
                    ...
                    <?php $doc_file = $this->egm->get_document_file_bydocumentid( $document['document_id']); ?>
      ...
      <div class="col-12 mt-3 mt-lg-5 text-center">
        <p class="my-3"><a href="<?php echo site_url($maincategory['category_meta_url']); ?>" class="btn btn-lg btn-icon btn-navy-transparent"><i class="fas fa-chevron-left"></i> กลับ</a></p>
      </div>
