...
<section id="page-body" class="bg-lightgrey page-sustainable py-3">
  <div class="container px-0">
    <div class="d-flex flex-wrap">
      ...
      <?php $this->load->view('sustainable/include/sidebar', $this->_data); ?>
      <div class="col-12 col-md-9 px-0 px-md-3 mb-3">
        <div id="breadcrumb" class="breadcrumb col-12 px-0 px-md-3 mb-3">
          <p>
            ...
            <a href="<?php echo site_url('sustainability'); ?>" class="btn-text black">การพัฒนาอย่างยั่งยืน</a>
            <a href="<?php echo site_url('sustainability/documents/'.$category['category_meta_url']); ?>" class="btn-text navy"><?php echo $category['category_title_'.$this->_language]; ?></a>
          </p>
        </div>
