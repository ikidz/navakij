        ...
        <div class="d-flex flex-wrap">
            ...
            <div id="breadcrumb" class="breadcrumb col-12 px-0 px-md-3 mb-3">
                <p>
                    ...
                    <a href="<?php echo site_url('knowledges/'.$category_info['category_meta_url']); ?>" class="btn-text black"><?php echo $category_info['category_title_'.$this->_language]?></a>
                    <a href="<?php echo site_url('knowledges/'.$article_info['article_meta_url']); ?>" class="btn-text navy"><?php echo $article_info['article_title_'.$this->_language];?></a>
                </p>
            </div>
            ...
            <div class="d-flex flex-wrap">
                ...
                <div class="col-12 mt-3 text-center">
                    <p class="my-3"><a href="<?php echo site_url('knowledges/'.$category_info['category_meta_url']); ?>" class="btn btn-lg btn-icon btn-navy-transparent"><i class="fas fa-chevron-left"></i> กลับ</a></p>
                </div>
            </div>
