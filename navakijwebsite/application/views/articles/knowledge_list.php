        ...
        <div class="d-flex flex-wrap">
            ...
            <div id="breadcrumb" class="breadcrumb col-12 px-0 px-md-3 mb-3">
                <p>
                    ...
                    <a href="<?php echo site_url('knowledges'); ?>" class="btn-text black">บทความควรรู้</a>
                    <a href="<?php echo site_url('knowledges/'.$category_info['category_meta_url']); ?>" class="btn-text navy"><?php echo $category_info['category_title_'.$this->_language]?></a>
                </p>
            </div>
            ...
            <div class="news-item col-12 col-md-4 px-0 px-md-3 my-3">
                <a href="<?php echo site_url('knowledges/'.$rs['article_meta_url']); ?>">
                    ...
                    <div class="news-item-title bg-darkgrey p-3">
                        <h4 class="navy"><?php echo mb_substr($rs['article_title_'.$this->_language], 0, 38, 'UTF-8'); ?><?php echo ( strlen( $rs['article_title_'.$this->_language] ) > 38 ? '...' :'' ); ?></h4>
                        <hr size="0" />
          ...
          <div class="col-12 d-flex flex-wrap justify-content-center">
            ...
            <div class="col-12 mt-3 text-center">
                ...
                <p class="my-3"><a href="<?php echo site_url('knowledges'); ?>" class="btn btn-lg btn-icon btn-navy-transparent"><i class="fas fa-chevron-left"></i> กลับ</a></p>
            </div>
