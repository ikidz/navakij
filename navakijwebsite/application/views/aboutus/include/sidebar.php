<div id="sidebar-wrapper" class="col-12 col-md-3 px-0 px-md-3 mb-3">
    <?php $subnavigations = $this->mainmodel->get_navigations( 5 ); ?>
                        ...
                        <?php
                            ...
                            if( in_array( $navigation['content_type'], array('insurance','articles','documents') ) === true ){
                                ...
                                if( $navigation['content_type'] == 'insurance' ){
                                    ...
                                    $main = $this->mainmodel->get_document_main_categoryinfo_byid( $navigation['category_id'] );
                                ...
                                if( $navigation['content_type'] == 'documents' ){
                                    if( isset( $content ) && count( $content ) > 0 ){
                                        $url = site_url($main['category_meta_url'].'/'.$category['category_meta_url'].'/'.$content['content_meta_url']);
                                        ...
                                        $url = site_url($main['category_meta_url'].'/'.$category['category_meta_url']);
