        ...
        <div class="widget-body form">
            <form method="post" name="menu_form" id="menu_form" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea class="span6" name="setting_value" id="setting_value" rows="5" style="resize:none;"><?php echo set_value('setting_value', $info['setting_value']); ?></textarea>
                        <?php if( $key == 'admin_email' ): ?>
                            <span class="help-block">*ใช้เครื่องหมาย , คั่นหากต้องการส่งหลายอีเมล</span>
                        <?php endif; ?>
                    </div>
                </div>
