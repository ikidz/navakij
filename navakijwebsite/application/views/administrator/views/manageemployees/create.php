<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> เพิ่มรายการพนักงาน</h4>
			<span class="tools">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							...
							<input type="text" class="input-large" name="employee_name_th" id="employee_name_th" placeholder="ชื่อพนักงาน *" value="<?php echo set_value('employee_name_th'); ?>" />
						</div>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							<span class="add-on"><i class="icon-font"></i></span>
							<input type="text" class="input-large" name="employee_name_en" id="employee_name_en" placeholder="ชื่อพนักงาน *" value="<?php echo set_value('employee_title_en'); ?>" />
						</div>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="span2" tab-index="1" name="employee_status" id="employee_status">
							<option value="approved" <?php echo set_select('employee_status','approved', TRUE); ?>>เปิดแสดงผล</option>
							<option value="pending" <?php echo set_select('employee_status','pending'); ?>>ปิดแสดงผล</option>
						</select>
					</div>
				</div>
