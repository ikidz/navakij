			...
			<form method="post" enctype="multipart/form-data" id="sortform" class="form-horizontal form-inline">
				...
				<div class="form-actions">
					<button type="submit" class="btn btn-primary" id="btn-submit"><i class="icon-search"></i> ค้นหา</button>
				 	<a class="btn" href="<?php echo admin_url("manageinsurancecontact/index/".$insurance_id); ?>"><i class="icon-list"></i> ดูทั้งหมด</a>
					 <button type="button" class="btn btn-success" id="btn-export"><i class="icon-download"></i> ส่งออกไปยัง Excels</button>
					 <a class="btn" href="<?php echo admin_url("manageinsurance/index/".$category_id); ?>"><i class="icon-undo"></i> กลับไปยังรายการประกันภัย</a>
				</div>
...
$(document).ready(function(){
	$('#btn-export').click(function(){
		$('#sortform').attr('action', '<?php echo site_url('administrator/manageinsurancecontact/export/'.$insurance_id, false); ?>');
		$('#sortform').submit();
