<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> แก้ไขบทความซ่อน</h4>
			<span class="tools">
		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="preview">
							<?php if( $info['article_image_th'] != '' && is_file( realpath('public/core/uploaded/hidden_article/'.$info['article_image_th']) ) === true ): ?>
								<img src="<?php echo base_url('public/core/uploaded/hidden_article/'.$info['article_image_th']); ?>" alt="" style="width:350px;" />
							<?php endif; ?>
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="preview">
							<?php if( $info['article_image_en'] != '' && is_file( realpath('public/core/uploaded/hidden_article/'.$info['article_image_en']) ) === true ): ?>
								<img src="<?php echo base_url('public/core/uploaded/hidden_article/'.$info['article_image_en']); ?>" alt="" style="width:350px;" />
							<?php endif; ?>
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php if( $info['article_file'] != '' && is_file( realpath('public/core/uploaded/hidden_article/file/'.$info['article_file']) ) === true ): ?>
							<a href="<?php echo site_url('public/core/uploaded/hidden_article/file/'.$info['article_file'], false); ?>" target="_blank"><i class="icon-download"></i> ดาวน์โหลด</a>
						<?php endif; ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="preview">
							<?php if( $info['article_facebook_image'] != '' && is_file( realpath('public/core/uploaded/hidden_article/facebook/'.$info['article_facebook_image']) ) === true ): ?>
								<img src="<?php echo base_url('public/core/uploaded/hidden_article/facebook/'.$info['article_facebook_image']); ?>" alt="" style="width:350px;" />
							<?php endif; ?>
						</div>
				...
				<div class="form-actions">
					<button type="submit" class="btn btn-mini btn-primary"><i class="icon-save"></i> บันทึก</button>
				 	<a class="btn btn-mini" href="<?php echo admin_url("managehiddenarticles/index"); ?>"><i class="icon-reply"></i> ยกเลิก</a>
				</div>
...
$(document).ready(function(){
	var category_meta_title = 'stview';
