<div class="span12" style="margin:0;">
	<div class="widget">
		...
		<div class="widget-body form">
			...
			<form method="get" enctype="multipart/form-data" id="sortform" class="form-horizontal form-inline" action="<?php echo admin_url('applicantsreport/profiles'); ?>">

				<div class="control-group">
					<label class="control-label" for="sort_keywords">คีย์เวิร์ด : </label>
					<div class="controls">
						<input type="text" class="span10" name="sort_keywords" id="sort_keywords" placeholder="ค้นหาจาก ชื่อ, เบอร์โทรศัพท์, อีเมล" value="<?php echo set_value('sort_keywords', $this->input->get('sort_keywords')); ?>" />
					</div>
				</div>
				...
				<div class="form-actions">
					<button type="submit" class="btn btn-primary" id="btn-submit"><i class="icon-search"></i> ค้นหา</button>
				 	<a class="btn" href="<?php echo admin_url("applicantsreport/profiles/"); ?>"><i class="icon-list"></i> ดูทั้งหมด</a>
...
$(document).ready(function(){
	$('#btn-export').click(function(){
		$('#sortform').attr('action', '<?php echo site_url('administrator/applicantsreport/profile_export', false); ?>');
		$('#sortform').submit();
