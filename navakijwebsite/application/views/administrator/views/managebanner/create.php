<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> เพิ่มแบนเนอร์</h4>
			<span class="tools">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="span6 chosen" id="article_id" name="article_id" tabindex="1">
							<option value="0" <?php echo set_select('article_id', 0, true); ?>>ไม่ลิงก์</option>
							<option value="9999" <?php echo set_select('article_id', '9999'); ?>>ลิงก์ไปยังที่อื่น</option>
						</select>
					</div>
				</div>

				<div id="url_other" class="control-group" style="display:none;">
					<label class="control-label" for="banner_url">URL * : </label>
					<div class="controls">
						<div class="input-append">
							<span class="add-on"><i class="icon-link"></i></span>
							<input type="text" class="input-large" name="banner_url" id="banner_url" placeholder="URL *" value="<?php echo set_value('banner_url'); ?>" />
						</div>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							...
							<input type="text" class="input-large" name="banner_title_th" id="banner_title_th" placeholder="ชื่อแบนเนอร์ *" value="<?php echo set_value('banner_title_th'); ?>" />
						</div>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							<span class="add-on"><i class="icon-font"></i></span>
							<input type="text" class="input-large" name="banner_title_en" id="banner_title_en" placeholder="ชื่อแบนเนอร์ *" value="<?php echo set_value('banner_title_en'); ?>" />
						</div>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="banner_caption_th" id="banner_caption_th" rows="5" class="span6 wysihtml5"><?php echo set_value('banner_caption_th'); ?></textarea>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="banner_caption_en" id="banner_caption_en" rows="5" class="span6 wysihtml5"><?php echo set_value('banner_caption_en'); ?></textarea>
					</div>
				</div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker" data-date="<?php echo date("d-m-Y"); ?>" data-date-format="dd-mm-yyyy">
                            <input type="text" name="banner_start_date" id="banner_start_date" value="<?php echo set_value('banner_start_date', date("d-m-Y")); ?>" class="input-small date-picker" readonly />
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker" data-date="<?php echo date("d-m-Y"); ?>" data-date-format="dd-mm-yyyy">
                            <input type="text" name="banner_end_date" id="banner_end_date" value="<?php echo set_value('banner_end_date', date("d-m-Y", strtotime('+1 year'))); ?>" class="input-small date-picker" readonly />
                            <span class="add-on"><i class="icon-calendar"></i></span>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="span2" tab-index="1" name="banner_status" id="banner_status">
							<option value="approved" <?php echo set_select('banner_status','approved', TRUE); ?>>เปิดแสดงผล</option>
							<option value="pending" <?php echo set_select('banner_status','pending'); ?>>ปิดแสดงผล</option>
						</select>
					</div>
				</div>
