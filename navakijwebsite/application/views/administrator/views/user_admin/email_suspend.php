...
<body style="font-size:12px;font-family:'Lucida Grande', 'Lucida Sans Unicode', Tahoma, Helvetica, Arial, Verdana, sans-serif;width:700px;">
	...
	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เราของแจ้งให้ทราบว่าคุณถูกระงับการใช้งานชั่วคราว โดยผู้ดูและระบบ ซึ่งมีผลโดยทันทีที่ได้รับอีเมมล์ฉบับนี้ โดยจะมีผลทำให้คุณไม่สามารถใช้งานระบบจัดการได้ จนกว่าผู้ดูแลระบบจะเปิดสิทธิ์กลับมาอีกครั้ง</p>
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	<p>&nbsp;</p>
