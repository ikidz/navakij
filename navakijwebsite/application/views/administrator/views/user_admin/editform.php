				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="user_group" id="user_group" class="span4" data-placeholder="เลือกกลุ่มผู้ใช้งาน">
		                   ...
		                   <option value="<?php echo $rs['group_id']; ?>" <?php if(set_value("user_group",@$row['user_group'])==$rs['group_id']){ ?> selected="selected" <?php } ?>><?php echo $rs['group_name']; ?></option>
		                   <?php } ?>
						</select>
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<select name="user_status" id="user_status" class="span4" data-placeholder="เลือกสถานะ">
						   ...
						   <option value="suspend" <?php if($row['user_status']=="suspend"){ ?> selected="selected" <?php } ?>>ระงับสิทธิ์</option>
						</select>
					</div>
				</div>
