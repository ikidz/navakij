...
<body style="font-size:12px;font-family:'Lucida Grande', 'Lucida Sans Unicode', Tahoma, Helvetica, Arial, Verdana, sans-serif;width:700px;">
	...
	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ยินดีต้อนรับคุณเป็นหนึ่งในผู้จัดการระบบของ <strong><?php echo $this->admin_library->getCompanyName(); ?></strong> โดยคุณสามารถเข้าใช้งานได้ในทันทีได้ที่ <a href="<?php echo admin_url(); ?>"><?php echo admin_url(); ?></a> ด้วยข้อมูลการเข้าใช้งานดังนี้</p>
