...
<body style="font-size:12px;font-family:'Lucida Grande', 'Lucida Sans Unicode', Tahoma, Helvetica, Arial, Verdana, sans-serif;width:700px;">
	...
	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เราของแจ้งให้ทราบว่าข้อมูลส่วนตัวของคุณได้รับการปรับปรุงแก้ไขเมื่อ <?php echo $user_updatedate; ?> โดยผู้ดูแลระบบ โดยคุณสามารถใช้ข้อมูลการเข้าสู่ระบบต่อไปนี้ในการเข้าใช้งานที่ <a href="<?php echo admin_url(); ?>"><?php echo admin_url(); ?></a></p>
