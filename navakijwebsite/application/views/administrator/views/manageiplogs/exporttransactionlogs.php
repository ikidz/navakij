...
<table cellspacing="0" cellpadding="0" border="1" style="width:100%;">
	<tr>
		<th colspan="4"><h2>รายการบันทึกการเข้าถึงเว็บไซต์ของ IP : <?php echo $info['ip']; ?></h2></th>
	</tr>
	...
	<tr>
		...
		<th class="" width="10%" >URL ที่เข้า</th>
		...
		if($lists){
			...
			foreach($lists as $list){
				...
				<tr>
					...
					<td style="padding-left:15px; vertical-align:middle;"><?php echo $list['current_url']; ?></td>
