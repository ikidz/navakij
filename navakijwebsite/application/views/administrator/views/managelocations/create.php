<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> เพิ่มรายการสถานที่</h4>
			<span class="tools">
		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="location_title_th" id="location_title_th" value="<?php echo set_value('location_title_th'); ?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="location_title_en" id="location_title_en" value="<?php echo set_value('location_title_en'); ?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="location_status" id="location_status">
							<option value="approved" <?php echo set_select('location_status','approved', true); ?>>เปิดการแสดงผล</option>
							<option value="pending" <?php echo set_select('location_status','pending'); ?>>ปิดการแสดงผล</option>
						</select>
					</div>
				</div>
