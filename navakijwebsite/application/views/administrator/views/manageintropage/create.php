<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> เพิ่ม Popup Special Day ใหม่</h4>
			<span class="tools">
		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="span6 chosen" id="intro_type" name="intro_type" tabindex="1">
							<option value="image" <?php echo set_select('intro_type', 'image', true); ?>>Image</option>
							<option value="youtube" <?php echo set_select('intro_type', 'youtube'); ?>>YouTube</option>
						</select>
					</div>
				</div>

				<div id="type-image" class="control-group">
				...
				<div id="type-youtube" class="control-group" style="display:none;">
					<label class="control-label" for="intro_value">YouTube ID * : </label>
					<div class="controls">
						https://www.youtube.com/watch?v=<input type="text" class="span2" name="intro_value" id="intro_value" placeholder="Youtube ID *" value="<?php echo set_value('intro_value'); ?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							...
							<input type="text" class="input-large" name="intro_url" id="intro_url" placeholder="URL" value="<?php echo set_value('intro_url'); ?>" />
						</div>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							...
							<input type="text" class="input-large" name="intro_title" id="intro_title" placeholder="ชื่อ Popup" value="<?php echo set_value('intro_title'); ?>" />
						</div>
					</div>
				</div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker" data-date="<?php echo date("d-m-Y"); ?>" data-date-format="dd-mm-yyyy">
                            <input type="text" name="intro_start_date" id="intro_start_date" value="<?php echo set_value('intro_start_date', date("d-m-Y")); ?>" class="input-small date-picker" readonly />
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker" data-date="<?php echo date("d-m-Y"); ?>" data-date-format="dd-mm-yyyy">
                            <input type="text" name="intro_end_date" id="intro_end_date" value="<?php echo set_value('intro_end_date', date("d-m-Y", strtotime('+1 year'))); ?>" class="input-small date-picker" readonly />
                            <span class="add-on"><i class="icon-calendar"></i></span>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="span2" tab-index="1" name="intro_status" id="intro_status">
							<option value="approved" <?php echo set_select('intro_status','approved', TRUE); ?>>เปิดแสดงผล</option>
							<option value="pending" <?php echo set_select('intro_status','pending'); ?>>ปิดแสดงผล</option>
						</select>
					</div>
				</div>
