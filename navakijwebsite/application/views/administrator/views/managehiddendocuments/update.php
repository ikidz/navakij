<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> แก้ไขรายการเอกสารซ่อน</h4>
			<span class="tools">
		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="preview">
							<?php if( $info['document_file'] != '' && is_file( realpath('public/core/uploaded/hidden_documents/'.$info['document_file']) ) === true ): ?>
								<a href="<?php echo base_url('public/core/uploaded/hidden_documents/'.$info['document_file']); ?>" target="_blank"><i class="icon-download"></i> ดาวน์โหลดไฟล์</a>
							<?php endif; ?>
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="preview">
							<?php if( $info['document_file_en'] != '' && is_file( realpath('public/core/uploaded/hidden_documents/'.$info['document_file_en']) ) === true ): ?>
								<a href="<?php echo base_url('public/core/uploaded/hidden_documents/'.$info['document_file_en']); ?>" target="_blank"><i class="icon-download"></i> ดาวน์โหลดไฟล์</a>
							<?php endif; ?>
						</div>
