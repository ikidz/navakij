		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="name_th" id="name_th" value="<?php echo set_value('name_th'); ?>" class="span6" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="name_en" id="name_en" value="<?php echo set_value('name_en'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="tel" id="tel" value="<?php echo set_value('tel'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="map_google" id="map_google" value="<?php echo set_value('map_google'); ?>" class="span6" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="span2" tab-index="1" name="status" id="status">
							<option value="approved" <?php echo set_select('status','approved', TRUE); ?>>เปิดแสดงผล</option>
							<option value="pending" <?php echo set_select('status','pending'); ?>>ปิดแสดงผล</option>
						</select>
					</div>
				</div>
