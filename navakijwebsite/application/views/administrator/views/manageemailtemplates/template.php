		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <p>&nbsp;</p>
                        <p style="font-size:12px;">คัดลอก <a href="javascript:void(0);" data-text-to-clipboard="{$applicant_fname}" class="btnClipboard">{$applicant_fname}</a> สำหรับ ชื่อจริงผู้สมัคร</p>
                        <p style="font-size:12px;">คัดลอก <a href="javascript:void(0);" data-text-to-clipboard="{$applicant_lname}" class="btnClipboard">{$applicant_lname}</a> สำหรับ นามสกุลผู้สมัคร</p>
                        <p style="font-size:12px;">คัดลอก <a href="javascript:void(0);" data-text-to-clipboard="{$applicant_createdtime}" class="btnClipboard">{$applicant_createdtime}</a> สำหรับ วันที่สมัคร</p>
