<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> เพิ่มข้อมูลตำแหน่งงาน</h4>
			<span class="tools">
		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="job_title_th" id="job_title_th" value="<?php echo set_value('job_title_th'); ?>" class="span6" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="job_title_en" id="job_title_en" value="<?php echo set_value('job_title_en'); ?>" class="span6" />
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="job_remark_label_th" id="job_remark_label_th" value="<?php echo set_value('job_remark_label_th'); ?>" class="span6" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="job_remark_label_en" id="job_remark_label_en" value="<?php echo set_value('job_remark_label_en'); ?>" class="span6" />
                ...
                <div class="control-group">
					...
					<div class="controls">
						<textarea name="job_responsibility_th" id="job_responsibility_th" rows="5" class="ckeditor"><?php echo set_value('job_responsibility_th'); ?></textarea>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<textarea name="job_responsibility_en" id="job_responsibility_en" rows="5" class="ckeditor"><?php echo set_value('job_responsibility_en'); ?></textarea>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<textarea name="job_qualification_th" id="job_qualification_th" rows="5" class="ckeditor"><?php echo set_value('job_qualification_th'); ?></textarea>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="job_qualification_en" id="job_qualification_en" rows="5" class="ckeditor"><?php echo set_value('job_qualification_en'); ?></textarea>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="job_amount" id="job_amount" value="<?php echo set_value('job_amount', 0); ?>" />
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="checkbox" name="is_appliable" id="is_appliable" value="1" <?php echo set_checkbox('is_appliable', 1); ?> /> เปิดใช้
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="checkbox" name="is_profile_leaving" id="is_profile_leaving" value="1" <?php echo set_checkbox('is_profile_leaving', 1); ?> /> เปิดใช้
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker" data-date="<?php echo date("d-m-Y"); ?>" data-date-format="dd-mm-yyyy">
                            <input type="text" name="job_start_date" id="job_start_date" value="<?php echo set_value('job_start_date', date("d-m-Y")); ?>" class="input-small date-picker" readonly />
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker" data-date="<?php echo date("d-m-Y", strtotime('+ 1 year')); ?>" data-date-format="dd-mm-yyyy">
                            <input type="text" name="job_end_date" id="job_end_date" value="<?php echo set_value('job_end_date', date("d-m-Y", strtotime('+ 1 year'))); ?>" class="input-small date-picker" readonly />
                            <span class="add-on"><i class="icon-calendar"></i></span>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="job_meta_title_th" id="job_meta_title_th" value="<?php echo set_value('job_meta_title_th'); ?>" class="span6" />
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="job_meta_title_en" id="job_meta_title_en" value="<?php echo set_value('job_meta_title_en'); ?>" class="span6" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="job_meta_description_th" id="job_meta_description_th" rows="5" class="span6" style="resize:none;"><?php echo set_value('job_meta_description_th'); ?></textarea>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<textarea name="job_meta_description_en" id="job_meta_description_en" rows="5" class="span6" style="resize:none;"><?php echo set_value('job_meta_description_en'); ?></textarea>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="job_meta_keywords_th" id="job_meta_keywords_th" value="<?php echo set_value('job_meta_keywords_th'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="job_meta_keywords_en" id="job_meta_keywords_en" value="<?php echo set_value('job_meta_keywords_en'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<select name="job_status" id="job_status">
							<option value="approved" <?php echo set_select('job_status','approved', true); ?>>เปิดการแสดงผล</option>
							<option value="pending" <?php echo set_select('job_status','pending'); ?>>ปิดการแสดงผล</option>
						</select>
					</div>
				</div>
