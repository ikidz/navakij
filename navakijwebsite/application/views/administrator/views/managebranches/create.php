<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> เพิ่มเครือข่าย</h4>
			<span class="tools">
		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="branch_title_th" id="branch_title_th" value="<?php echo set_value('branch_title_th'); ?>" class="span6" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="branch_title_en" id="branch_title_en" value="<?php echo set_value('branch_title_en'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="branch_tel" id="branch_tel" value="<?php echo set_value('branch_tel'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="branch_fax" id="branch_fax" value="<?php echo set_value('branch_fax'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="branch_email" id="branch_email" value="<?php echo set_value('branch_email'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="branch_website" id="branch_website" value="<?php echo set_value('branch_website'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<textarea name="branch_address" id="branch_address" class="span6" rows="4" style="resize:none;"><?php echo set_value('branch_address'); ?></textarea>
					</div>
				</div>
                        ...
                        <select name="province_id" id="province_id">
                            ...
                            <?php if( isset( $provinces ) && count( $provinces ) > 0 ): ?>
                                <?php foreach( $provinces as $province ): ?>
                                    <option value="<?php echo $province['province_id']; ?>" <?php echo set_select('province_id', $province['province_id']); ?>><?php echo $province['name']; ?></option>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </select>
                    </div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="card" id="card" value="<?php echo set_value('card'); ?>" class="span6" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="patient_department" id="patient_department" value="<?php echo set_value('patient_department'); ?>" class="span6" />
					</div>
				</div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="checkbox" name="is_partner" id="is_partner" value="1" <?php echo set_checkbox('is_partner', 1); ?> />
                    </div>
                </div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="branch_lat" id="branch_lat" value="<?php echo set_value('branch_lat'); ?>" class="span6" />
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="branch_lng" id="branch_lng" value="<?php echo set_value('branch_lng'); ?>" class="span6" />
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="branch_gmap_url" id="branch_gmap_url" value="<?php echo set_value('branch_gmap_url'); ?>" class="span6" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="span2" tab-index="1" name="branch_status" id="branch_status">
							<option value="approved" <?php echo set_select('branch_status','approved', TRUE); ?>>เปิดแสดงผล</option>
							<option value="pending" <?php echo set_select('branch_status','pending'); ?>>ปิดแสดงผล</option>
						</select>
					</div>
				</div>
