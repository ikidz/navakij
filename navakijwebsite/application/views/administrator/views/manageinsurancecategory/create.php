...
<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> เพิ่มหมวดหมู่</h4>
			<span class="tools">
		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="insurance_category_icon" id="insurance_category_icon" class="span4 chosen" data-placeholder="เลือก Icon" style="font-family: 'icomoon', sans-serif !important;">
					       ...
					       <option  style="font-family: 'icomoon', sans-serif !important;" value="<?php echo $key; ?>" <?php if(set_value("insurance_category_icon")==$key){ ?> selected="selected" <?php } ?>><?php echo str_replace("\\","&#x",$text); ?> <?php echo ucfirst(str_replace("icon-","",$key)); ?></option>
					       <?php } ?>
						</select>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="insurance_category_title_th" id="insurance_category_title_th" value="<?php echo set_value('insurance_category_title_th'); ?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="insurance_category_title_en" id="insurance_category_title_en" value="<?php echo set_value('insurance_category_title_en'); ?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="insurance_category_status" id="insurance_category_status">
							<option value="approved" <?php echo set_select('insurance_category_status','approved', true); ?>>เปิดการแสดงผล</option>
							<option value="pending" <?php echo set_select('insurance_category_status','pending'); ?>>ปิดการแสดงผล</option>
						</select>
					</div>
				</div>
