		...
		<div class="widget-body form">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="preview">
							<?php if( $info['article_thumbnail'] != '' && is_file( realpath('public/core/uploaded/article/thumb/'.$info['article_thumbnail']) ) === true ): ?>
								<img src="<?php echo base_url('public/core/uploaded/article/thumb/'.$info['article_thumbnail']); ?>" alt="" style="width:250px;" />
							<?php endif; ?>
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="preview">
							<?php if( $info['article_image_en'] != '' && is_file( realpath('public/core/uploaded/article/'.$info['article_image_en']) ) === true ): ?>
								<img src="<?php echo base_url('public/core/uploaded/article/'.$info['article_image_en']); ?>" alt="" style="width:350px;" />
							<?php endif; ?>
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php if( $info['article_file'] != '' && is_file( realpath('public/core/uploaded/article/file/'.$info['article_file']) ) === true ): ?>
							<a href="<?php echo site_url('public/core/uploaded/article/file/'.$info['article_file'], false); ?>" target="_blank"><i class="icon-download"></i> ดาวน์โหลด</a>
						<?php endif; ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="preview">
							<?php if( $info['article_facebook_image'] != '' && is_file( realpath('public/core/uploaded/article/facebook/'.$info['article_facebook_image']) ) === true ): ?>
								<img src="<?php echo base_url('public/core/uploaded/article/facebook/'.$info['article_facebook_image']); ?>" alt="" style="width:350px;" />
							<?php endif; ?>
						</div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker" data-date="<?php echo date("d-m-Y", strtotime( ( $info['article_postdate'] ? $info['article_postdate'] : date("Y-m-d") ) ) ); ?>" data-date-format="dd-mm-yyyy">
                            <input type="text" name="article_postdate" id="article_postdate" value="<?php echo set_value('article_postdate', date("d-m-Y", strtotime( ( $info['article_postdate'] ? $info['article_postdate'] : date("Y-m-d") ) ))); ?>" class="input-small date-picker" readonly />
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker" data-date="<?php echo date("d-m-Y", strtotime( ( $info['article_start_date'] ? $info['article_start_date'] : date("Y-m-d") ) ) ); ?>" data-date-format="dd-mm-yyyy">
                            <input type="text" name="article_start_date" id="article_start_date" value="<?php echo set_value('article_start_date', date("d-m-Y", strtotime( ( $info['article_start_date'] ? $info['article_start_date'] : date("Y-m-d") ) ) ) ); ?>" class="input-small date-picker" readonly />
                            <span class="add-on"><i class="icon-calendar"></i></span>
                        </div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker" data-date="<?php echo date("d-m-Y"); ?>" data-date-format="dd-mm-yyyy">
                            <input type="text" name="article_end_date" id="article_end_date" value="<?php echo set_value('article_end_date', ( $info['article_end_date'] != '' ? date("d-m-Y", strtotime( $info['article_end_date'] ) ) : '' ) ); ?>" class="input-small date-picker" readonly />
                            <span class="add-on"><i class="icon-calendar"></i></span>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="article_status" id="article_status">
							<option value="approved" <?php echo set_select('article_status','approved', $info['article_status'] == 'approved'); ?>>เปิดการแสดงผล</option>
							<option value="pending" <?php echo set_select('article_status','pending', $info['article_status'] == 'pending'); ?>>ปิดการแสดงผล</option>
						</select>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="article_meta_title" id="article_meta_title" value="<?php echo set_value('article_meta_title', $info['article_meta_title']); ?>" class="span6" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="article_meta_description" id="article_meta_description" rows="5" class="span6" style="resize:none;"><?php echo set_value('article_meta_description', $info['article_meta_description']); ?></textarea>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="article_meta_keyword" id="article_meta_keyword" value="<?php echo set_value('article_meta_keyword', $info['article_meta_keyword']); ?>" class="span6" />
					</div>
				</div>

				<div class="control-group">
					<label class="control-label" for="article_meta_url">URL : *</label>
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-link"></i></span>
							<input type="text" class="input-large" name="article_meta_url" id="article_meta_url" placeholder="URL *" value="<?php echo set_value('article_meta_url', $info['article_meta_url']); ?>" />
						</div>
					</div>
				</div>
