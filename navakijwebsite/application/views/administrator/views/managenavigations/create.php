<div class="span12">
	<div class="widget">
		<div class="widget-title">
			<h4><i class="icon-cogs"></i> เพิ่มเมนูเว็บไซต์</h4>
			<span class="tools">
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div id="external_link" class="control-group content-type" <?php echo ( $this->input->post('content_type') == 'external_link' || !$this->input->post('content_type') ? '' : 'style="display:none;"'); ?>>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="nav_external_url" id="nav_external_url" value="<?php echo set_value('nav_external_url'); ?>" class="span6" />
                        </div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="nav_title_th" id="nav_title_th" value="<?php echo set_value('nav_title_th'); ?>" class="span6" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="nav_title_en" id="nav_title_en" value="<?php echo set_value('nav_title_en'); ?>" class="span6" />
                    </div>
                </div>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<select class="span2" tab-index="1" name="nav_status" id="nav_status">
							<option value="approved" <?php echo set_select('nav_status','approved', TRUE); ?>>เปิดแสดงผล</option>
							<option value="pending" <?php echo set_select('nav_status','pending'); ?>>ปิดแสดงผล</option>
						</select>
					</div>
				</div>
				...
				<div class="form-actions">
					...
					<button type="submit" class="btn btn-mini btn-primary"><i class="icon-save"></i> บันทึกข้อมูล</button>
				 	<a class="btn btn-mini" href="<?php echo admin_url("managenavigations/index/".$mainid); ?>"><i class="icon-save"></i> ยกเลิก</a>
				</div>
